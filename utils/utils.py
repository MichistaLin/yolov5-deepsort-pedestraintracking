...
def check_git_status():
    ...
    if False:#if platform in ['linux', 'darwin'] and not os.path.isfile('/.dockerenv'):
...
def plot_one_box(x, img, color=[100,100,100], text_info="None",velocity=None,thickness=None,fontsize=None,fontthickness=None):
    ...
    fontthickness = max(1,round(0.4*thickness)-2) if fontthickness==None else fontthickness
